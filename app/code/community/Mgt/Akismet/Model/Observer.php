...
class Mgt_Akismet_Model_Observer
{
    ...
    protected function _getAkismet()
    {
     ...
     public function redirect_config(Varien_Event_Observer $observer){
        if(Mage::app()->getRequest()->getParam('section') == 'mgtakismetaaa')
        {
            header("Location:".Mage::getUrl('adminhtml/mgt'));
            exit;
        }
    }
}