...
class Ebizmarts_MageMonkey_Model_Observer
{
	...
	public function handleSubscriber(Varien_Event_Observer $observer)
	{
        ...
        if( TRUE === $subscriber->getIsStatusChanged() ){
			...
			$mrg=$this->_mergeVars($subscriber);
			if(isset($mrg['DONTEMAIL']) && $mrg['DONTEMAIL']=='Y'){
				Mage::getSingleton('monkey/api')->listSubscribe($listId, $email, $this->_mergeVars($subscriber), 'html', false);
			}else{
