...
{  
  ...
  public function clearcacheAction(){
    ...
    {
  		$this->_initAction();   			
      $block = $this->getLayout()->createBlock('magebird_popup/adminhtml_template')->setTemplate('magebird/popup/review.phtml');          
      $this->getResponse()->setBody($block->toHtml());
    }      
    ...
    {
  		$this->_initAction();   			
      $block = $this->getLayout()->createBlock('magebird_popup/adminhtml_template')->setTemplate('magebird/popup/timer.phtml');          
      $this->getResponse()->setBody($block->toHtml());
    }      
