 ...
 */
class Itoris_LayeredNavigation_Model_Enterprise_Layer_MultiFilter_Category_Tree
			extends Itoris_LayeredNavigation_Model_Enterprise_Layer_MultiFilter_Category {
