<?php
/**
 * Bugfix (http://www.magentocommerce.com/bug-tracking/issue?issue=14217)
 *
 * Class Mod_Adminhtml_Model_Config_Data
 */
class Mod_Adminhtml_Model_Config_Data extends Mage_Adminhtml_Model_Config_Data
{
    /**
     * Save config section
    ...
    public function save()
    {
        ...
        foreach ($groups as $group => $groupData) {
            ...
            foreach ($groupData['fields'] as $field => $fieldData) {
                ...
                /* Start rewrite (bugfix) http://www.magentocommerce.com/bug-tracking/issue?issue=14217 */
				unset( $backendClass ); 
