...
class CommerceExtensions_Customerreviewsimportexport_Model_Profile extends Mage_Dataflow_Model_Profile
{
...
//            $parseDataXml .= '</action>'.$nl.$nl;
            ...
            $parseDataXml = '<action type="customerreviewsimportexport/convert_parser_customerreviewexport" method="unparse">' . $nl;
            $parseDataXml .= '    <var name="store"><![CDATA[' . $this->getStoreId() . ']]></var>' . $nl;
        ...
        if ($import) {
			...
			*/
            ...
            if ($this->getDataTransfer()==='interactive') {
                ...
                $xml .= '    <var name="adapter">customerreviewsimportexport/convert_adapter_customerreviewimport</var>' . $nl;
