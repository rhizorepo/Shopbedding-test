...
class Shopbedding_Newsletter_SubscriberController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function newAction()
    {
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            $name['first']          = (string) $this->getRequest()->getPost('first_name');
            $name['last']           = (string) $this->getRequest()->getPost('last_name');
			$name['SOURCE']			= 'signup1';
        ...
        if((boolean) strstr($this->_getRefererUrl(), "/newsletter/subscriber/steptwo"))
        {
