...
class Shopbedding_PromoDisplay_Model_PageCache_Container_Promodisplaybannerproduct extends Enterprise_PageCache_Model_Container_Abstract
{
    protected function _getCacheId()
    {
        ...
        if ($cacheId) {
            ...
            $id = 'PROMODISPLAY_PRODUCT'.
                md5(
                    'PROMODISPLAY_PRODUCT container="'.$container.'" ' .
