<?php
/**
 * Class Shopbedding_Dataflow_Model_Dataflow_Profile
 */
class Shopbedding_Dataflow_Model_Dataflow_Profile extends Mage_Dataflow_Model_Profile
{
    /* Start code override */
    const IMPORT_AND_ASSOCIATE_CONFIGURABLE_PRODUCTS = 7;
    /* End code override */
...
//            $parseDataXml .= '</action>'.$nl.$nl;
        ...
        /* Start code override */
        /**
         * Use catalog/convert_adapter_associatedproducts adapter for "Import and Associate Configurable Products" profile
         */
        if ($this->getProfileId() == self::IMPORT_AND_ASSOCIATE_CONFIGURABLE_PRODUCTS) {
            $adapters['product'] = 'catalog/convert_adapter_associatedproducts';
        }
        /* End code override */
