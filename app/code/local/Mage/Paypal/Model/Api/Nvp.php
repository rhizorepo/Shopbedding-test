...
//    protected $_manageRecurringPaymentsProfileStatusResponse = array('PROFILEID');
    ...
    public function callDoExpressCheckoutPayment()
    {
        ...
        foreach ($backtrace as $line) {
            if (is_array($line) && isset($line['args'])) {
                unset($line['args']);
            }
            $brArr[] = $line;
        }
        //Mage::log(print_r($brArr, 1), null, 'special_paypal.log');
        //Mage::log(print_r($_SERVER, 1), null, 'special_paypal.log');
        ## end custom logic
    ...
    public function call($methodName, array $request)
    {
        ...
        try {
            ...
            // Fix CURL version (Need update in system)
