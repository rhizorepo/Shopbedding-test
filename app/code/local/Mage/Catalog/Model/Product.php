 ...
 */
     ...
     * @return Mage_Catalog_Model_Product
     */
    public function addImageToMediaGallery($file, $mediaAttribute=null, $move=false, $exclude=true, $label=null, $sort=null, $swatch_image=null, $swatch_image_label=null, $isCategory = null)
    {
        ...
        $mediaGalleryAttribute->getBackend()->addImage($this, $file, $mediaAttribute, $move, $exclude, $label, $sort, $swatch_image, $swatch_image_label, $isCategory);
        return $this;
    }
