...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _loginPostRedirect()
    {
		...
		$session->setSuccessAuthorization(true);
    ...
    public function forgotPasswordPostAction()
    {
        ...
        if ($email) {
            ...
            $this->_getSession()
                ->addSuccess(Mage::helper('customer')->__('You will receive an email with a link to reset your password.', Mage::helper('customer')->htmlEscape($email)));
            $this->_redirect('*/*/');
            return;
        } else {
