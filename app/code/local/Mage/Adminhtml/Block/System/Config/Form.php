    ...
    public function initFields($fieldset, $group, $section, $fieldPrefix='', $labelPrefix='')
    {
        ...
        foreach ($group->fields as $elements) {
            ...
            foreach ($elements as $element) {
				...
				/* gorilla: add date type for fields */
				$options = array(
                    'name'                  => $name,
                    'label'                 => $label,
                    'comment'               => $comment,
				...
				if($fieldType == 'date') {
					$input_format	 = isset($element->frontend_input_format)? (string) $element->frontend_input_format : Varien_Date::DATE_INTERNAL_FORMAT;
					$format			 = isset($element->frontend_format)? (string) $element->frontend_format : Mage_Core_Model_Locale::FORMAT_TYPE_SHORT;
					$dateFormatIso = Mage::app()->getLocale()->getDateFormat($format);
                ...
                $field = $fieldset->addField($id, $fieldType, $options);
