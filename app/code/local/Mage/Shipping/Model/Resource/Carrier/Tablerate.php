...
class Mage_Shipping_Model_Resource_Carrier_Tablerate extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    protected function _getImportRow($row, $rowNumber = 0)
    {
		...
		//================ custom code added by rhizonex for id_name ==============
		 if ($row[5] == '') {
            $id_name = '';
        } else {
            $id_name = $row[5];
        ...
        return array(
            ...
            $price,                      // price
			$id_name					//custom code for id_name by rhizonex=================================
        );
    }
     ...
     * @return Mage_Shipping_Model_Resource_Carrier_Tablerate
     */
	 //========================== custom id name for id_name by rhizonex ==================================
    protected function _saveImportData(array $data)
    {
        if (!empty($data)) {
            $columns = array('website_id', 'dest_country_id', 'dest_region_id', 'dest_zip',
                'condition_name', 'condition_value', 'price','id_name');
