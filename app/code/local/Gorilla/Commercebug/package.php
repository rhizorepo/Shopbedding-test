<?php
	class Commercebug_Packager
	{
		...
		{
			$string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Alanstormdotcom_Commercebug><active>true</active><codePool>local</codePool></Alanstormdotcom_Commercebug></modules></config>';
			$string = str_replace('Alanstormdotcom_', $this->namespace . '_',$string);
