<?php
	class Gorilla_Commercebug_Block_Html extends Mage_Core_Block_Template
	{
		...
		//86400 = 1 day	 	
	 	...
	 	{			
	 		$last_time = json_decode(Mage::getStoreConfig('commercebug/options/update_last_check'));
		...
		public function getLastUpdateCheck()
		{
	 	...
	 	public function resetLastUpdated()
	 	{
			...
			$groups_value 		= array();			
			$groups_value['options']['fields']['update_last_check']['value'] = json_encode($object);
