...
class Mirasvit_FpcCrawler_Block_Adminhtml_System_SortByProductAttribute extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    {
        return 'fpccrawler_crawler_sort_crawler_urls';
    }
