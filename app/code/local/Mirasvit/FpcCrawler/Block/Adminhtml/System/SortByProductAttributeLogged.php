...
class Mirasvit_FpcCrawler_Block_Adminhtml_System_SortByProductAttributeLogged extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    protected function _getOptionsRenderer()
    {
        if (!$this->_optionsRenderer) {
            $this->_optionsRenderer = Mage::app()->getLayout()->createBlock(
                'fpccrawler/adminhtml_system_attributeOption', '',
                array('is_render_to_js_template' => true)
            );
            $this->_optionsRenderer->setClass('customer_options_select_logged');
    ...
    {
        return 'fpccrawler_crawler_logged_sort_crawler_urls';
    }
