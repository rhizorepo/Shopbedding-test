...
class Mirasvit_FpcCrawler_Block_Adminhtml_System_SortByPageTypeLogged extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    protected function _getOptionsRenderer()
    {
        if (!$this->_optionsRenderer) {
            $this->_optionsRenderer = Mage::app()->getLayout()->createBlock(
                'fpccrawler/adminhtml_system_actionOption', '',
