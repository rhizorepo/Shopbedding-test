(function($){
    ...
    function setActiveDepths(currentDepthSelected){
        $(".product-depth-option").each(function(){
            ...
            for (j = 0;j<depthArray.length;j++) {
                ...
                if(depthArray[j]==currentDepthSelected) {depthAvailable = true};
            }
    ...
    function setActiveDropLengths(currentDropSelected){
        $(".product-drop-option").each(function(){
            ...
            for (j = 0;j<dropArray.length;j++) {
                ...
                if(dropArray[j]==currentDropSelected) {dropAvailable = true};
            }
    ...
    $(function(){
        ...
        $(".color-swatches a").click(function(){
            ...
            if ($('select option[value=' + whichColorOption + ']', parent).length == 0){
                ...
                $('select', parent).val(whichColorOption).trigger("change");
       ...
       $(".toggle-large-qty").click(function(){
        ...
        $("#byos-block .add-to-set").click(function() {
             ...
             if (isError) { 
                ...
                setTimeout(function() { $('.added-to-set').css('visibility', 'hidden'); }, 2000);
...
if (size){
        ...
        $("#byos-block .btn-add-to-set").click(function(){
            ...
            if ($itemRows.length == 0){
                ...
                setTimeout(function() { $('.add-to-cart .validation-advice, .byos-instructions .validation-advice').hide().remove(); }, 2000);
                return false;
            }
                ...
                "/byos/add/allcart", { 'setItems': items.toString() }, function(data) {
                    if (data.error == '0'){
                        ...
                        $("#byos-cart-items .add-set-error").fadeIn('fast', function(){
                            setTimeout(function() { $("#byos-cart-items .add-set-error").fadeOut("fast"); }, 3500);
                        });
                    }
                }, 'json');
