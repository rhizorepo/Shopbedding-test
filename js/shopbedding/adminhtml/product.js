Product.MovadoGallery = Class.create();
Product.MovadoGallery.prototype = {
    images : [],
    file2id : {
        'no_selection' :0
    },
    ...
    handleUploadComplete : function(files) {
        files.each( function(item) {
            ...
            //label3
            newImage.label = '';
            newImage.swatchimage = '';
            newImage.swatchimage_label = '';
    ...
    updateImage : function(file) {
        ...
        this.images[index].swatchimage = this
            .getFileElement(file, 'cell-swatchimage input').value;
        this.images[index].swatchimage_label = this
            .getFileElement(file, 'cell-swatchimage-label input').value;
		...
		this.images[index].is_category = (this.getFileElement(file,
                'cell-is_category input').checked ? 1 : 0);
        this.getElement('save').value = Object.toJSON(this.images);
    ...
    updateVisualisation : function(file) {
        ...
        this.getFileElement(file, 'cell-swatchimage input').value = image.swatchimage;
        this.getFileElement(file, 'cell-swatchimage-label input').value = image.swatchimage_label;

        this.getFileElement(file, 'cell-position input').value = image.position;
        this.getFileElement(file, 'cell-remove input').checked = (image.removed == 1);
        this.getFileElement(file, 'cell-disable input').checked = (image.disabled == 1);
        this.getFileElement(file, 'cell-is_category input').checked = (image.is_category == 1);
		$H(this.imageTypes)
                .each(
                        function(pair) {
