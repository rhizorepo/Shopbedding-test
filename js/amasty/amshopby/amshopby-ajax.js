    ...
    var request = new Ajax.Request(url,{
            ...
            onSuccess: function(response){
                try {
					...
					jqr('#amshopby-page-container').parent().parent().parent().addClass('padding30');
					var amt_str = jqr('.toolbar .pager .amount').html();
					var amt_arr = amt_str.split('of');
					jqr('.filter-count.color-red').html(amt_arr[1]);
