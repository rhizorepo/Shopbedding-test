jQueryCommercebug.fn.commercebug = function(l_commercebug_json) {
	...
	function init_models(pElement)
	{
		...
		table.push('<thead><tr><th>Model Name<\/th><th>Times Instantiated<\/th><\/tr><\/thead>');
	...
	function init_blocks(pElement)
	{
		...
		table.push('<thead><tr><th>Block Name<\/th><th>Times Instantiated<\/th><th>With Template<\/th><\/tr><\/thead>');			
	...
	function init_layout(pElement)
	{
		...
		var c=0;
		results.push('<thead><tr><th>Handles for this Request<\/th><\/tr><\/thead>');			
		results.push('<tbody>');
		...
		results.push('<span id="'+s_prefix+'_page_layout_label">View Page Layout:<\/span><a href="?showLayout=page&showLayoutFormat=xml" target="_blank">XML<\/a> | <a href="?showLayout=page&showLayoutFormat=text" target="_blank">Text<\/a>');
		results.push('<\/td><\/tr>');
		c++;
		var odd_or_even = c % 2 ? 'odd' : 'even' ;
		results.push('<tr class="'+odd_or_even+'"><td>');
		results.push('<span id="'+s_prefix+'_page_layout_label">View Package Layout: <\/span><a href="?showLayout=package&showLayoutFormat=xml" target="_blank">XML<\/a> | <a href="?showLayout=package&showLayoutFormat=text" target="_blank">Text<\/a>');
		results.push('<\/td><\/tr>');
		results.push('<\/tfoot>');			
		results.push('<\/tbody>');			
		results.push('<\/table>');						
