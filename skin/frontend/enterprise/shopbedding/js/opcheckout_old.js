...
Checkout.prototype = {
    ...
    updateCheckoutProgress: function(){
        jQuery(".opc-progress-container dl dt").removeClass("active");
        jQuery("#checkoutSteps li.active").each(function(){
    ...
    reloadProgressBlock: function(){
        var updater = new Ajax.Updater('col-right-opcheckout', this.progressUrl, {
            ...
            onComplete: this.updateCheckoutProgress
        });
    },
...
//            var elements = form.select('input', 'select', 'textarea');
            var elementsInput = form.select('input');
            var elementsSelect = form.select('select');
            var elementsTextarea = form.select('textarea');
            var elements = elementsInput.concat(elementsSelect,elementsTextarea);
